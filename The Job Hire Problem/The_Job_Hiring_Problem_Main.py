...
if SamplingMethod1Status == True:
    ...
    for j in range (1,21):
        ...
        if int(globals()[applicant_name]) >= highest_actual_score:  # Access the variable using its name
            print("The best applicant to hire was " + applicant_name)
...
# Todo: 
# 1. Add a seqeunce that verifies whether the applicant that was selected was the best applicant in the batch
